...
additionalInfoArea.placeholder =
  "Type some text to us. Beware, number 1 is denied to input";
...
document.getElementById("submit-btn").addEventListener("click", (e) => {
  ...
  function formValidation() {
    ...
    if (nameController === false) {
      alert(
        "Please enter the correct name (a-z, A-Z, length from 3 to 15 symbols)"
      );
    }
