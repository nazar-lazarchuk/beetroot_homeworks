...
let userNumber = +prompt(`Put number to receive all dividers`);
...
if (sumPurchase < 200) {
    ...
    alert('You have discount 3%,' + ' ' + 'your amount has become' + ' ' + sumPurchase * (1 - discount_3 / 100));
} else if (sumPurchase < 500) {
    alert('You have discount 5%,' + ' ' + 'your amount has become' + ' ' + sumPurchase * (1 - discount_5 / 100));
} else {
    alert('You have discount 7%,' + ' ' + 'your amount has become' + ' ' + sumPurchase * (1 - discount_7 / 100));
}