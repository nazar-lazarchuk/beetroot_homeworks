...
document.getElementById('submit-btn').addEventListener('click', (e) => {
    ...
    function formValidation() {
        ...
        let dataTransition = {}; // transport file

        dataTransition.name = inputedName;
        dataTransition.data = inputedDate;
        dataTransition.login = inputedLogin;

        console.log(dataTransition);

        formaData = JSON.stringify(dataTransition);
